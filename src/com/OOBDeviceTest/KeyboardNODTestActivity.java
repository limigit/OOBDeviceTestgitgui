...
public class KeyboardNODTestActivity extends Activity  {
	...
	int []key=new int[]{4,3,231,176,91,25,24,223,224,220,226,222,228,64,120,112,
	   		...
	   		59,81,54,52,31,50,30,42,41,55,56,69,60,
...
"L_Ctrl","Search","Recent task","L_Alt","Space","R_Alt","Menu","R_Ctrl","PgUp","Pad_Up","PgDn",
   ...
   BoardKeyNOD[] bkey=new BoardKeyNOD[84];
	  {
		  for(int i=0;i<84;i++)
		 {bkey[i]=new BoardKeyNOD();
	      }
  	  for(int i=0;i<84;i++){
   ...
   private final static String TAG = "KeyboardNODTestActivity";  
  ...
  public void onCreate(Bundle savedInstanceState) {
      ...
      setContentView(R.layout.keyboard_nod_test);
    ...
    //  skipButton = (Button)findViewById(R.id.btn_Skip);
      ...
      failButton.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
				...
				KeyboardNODTestActivity.this.finish();
			}
		});
		/*
