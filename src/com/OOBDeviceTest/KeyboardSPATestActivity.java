...
public class KeyboardSPATestActivity extends Activity  {
...
"Caps Lock","A","S","D","F","G","H","J","K","L","N~","{","Enter",
...
"L_Ctrl","Search","Recent task","L_Alt","Space","R_Alt","Menu","R_Ctrl","PgUp","Pad_Up","PgDn",
   ...
   BoardKeySPA[] bkey=new BoardKeySPA[84];
	  {
		  for(int i=0;i<84;i++)
		 {bkey[i]=new BoardKeySPA();
	      }
  	  for(int i=0;i<84;i++){
  ...
  public void onCreate(Bundle savedInstanceState) {
      ...
      setContentView(R.layout.keyboard_spa_test);
    ...
    //  skipButton = (Button)findViewById(R.id.btn_Skip);
      ...
      failButton.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
				...
				KeyboardSPATestActivity.this.finish();
			}
		});
		/*
