...
public class SpeakerTestActivityForLenovo extends Activity implements
		OnClickListener {
	public static final String TAG = "SpeakerTestActivityForLenovo";
	...
	protected void onCreate(Bundle paramBundle) {
		...
		setContentView(R.layout.speakertestforlenovo);
	...
	/*	
		...
		retestButton.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
				onPause();
				mLeftCount = 0;mRightCount = 0;
				mLeftRandomCount = 0;mRightRandomCount = 0;
				mNowVolunm = 0; mPressBtnNum = 0;
				mNumberPadView.setVisibility(View.INVISIBLE);
...
*/
	...
	protected void onPause() {
		...
		mHandler.removeMessages(MSG_START_LEFT);
		mHandler.removeMessages(MSG_SHOW_MESSAGE);
		mHandler.removeMessages(MSG_START_RIGHT);
		mHandler.removeMessages(MSG_PLAY_MUSIC);
