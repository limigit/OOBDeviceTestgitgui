...
public class KeyboardPORTestActivity extends Activity  {
...
"Caps Lock","A","S","D","F","G","H","J","K","L","C,","O_","Enter",
...
"L_Ctrl","Search","Recent task","L_Alt","Space","R_Alt","Menu","R_Ctrl","PgUp","Pad_Up","PgDn",
   ...
   BoardKeyPOR[] bkey=new BoardKeyPOR[84];
	  {
		  for(int i=0;i<84;i++)
		 {bkey[i]=new BoardKeyPOR();
	      }
  	  for(int i=0;i<84;i++){
  ...
  public void onCreate(Bundle savedInstanceState) {
      ...
      setContentView(R.layout.keyboard_por_test);
    ...
    //  skipButton = (Button)findViewById(R.id.btn_Skip);
      ...
      failButton.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
				...
				KeyboardPORTestActivity.this.finish();
			}
		});
		/*
