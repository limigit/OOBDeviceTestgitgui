...
public class KeyboardLATTestActivity extends Activity  {
...
"Bloq","A","S","D","F","G","H","J","K","L","N~","[","Enter",
...
"L_Ctrl","Search","Recent task","L_Alt","Space","R_Alt","Menu","R_Ctrl","PgUp","Pad_Up","PgDn",
   ...
   BoardKeyLAT[] bkey=new BoardKeyLAT[84];
	  {
		  for(int i=0;i<84;i++)
		 {bkey[i]=new BoardKeyLAT();
	      }
  	  for(int i=0;i<84;i++){
   ...
   private final static String TAG = "KeyboardLATTestActivity";  
  ...
  public void onCreate(Bundle savedInstanceState) {
      ...
      setContentView(R.layout.keyboard_lat_test);
    ...
    //  skipButton = (Button)findViewById(R.id.btn_Skip);
      ...
      failButton.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
				...
				KeyboardLATTestActivity.this.finish();
			}
		});
		/*
