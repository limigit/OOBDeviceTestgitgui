...
public class KeyboardBRATestActivity extends Activity  {
...
"Caps Lock","A","S","D","F","G","H","J","K","L","C,","~","Enter",
...
"L_Ctrl","Search","Recent task","L_Alt","Space","R_Alt","Menu","R_Ctrl","PgUp","Pad_Up","PgDn",
   ...
   BoardKeyBRA[] bkey=new BoardKeyBRA[84];
	  {
		  for(int i=0;i<84;i++)
		 {bkey[i]=new BoardKeyBRA();
	      }
  	  for(int i=0;i<84;i++){
   ...
   private final static String TAG = "KeyboardBRATestActivity";  
  ...
  public void onCreate(Bundle savedInstanceState) {
      ...
      setContentView(R.layout.keyboard_bra_test);
    ...
    //  skipButton = (Button)findViewById(R.id.btn_Skip);
      ...
      failButton.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
				...
				KeyboardBRATestActivity.this.finish();
			}
		});
		/*
