...
public class KeyboardITATestActivity extends Activity  {
   ...
   String[] keyName=new String[]{"Back","Home" ,"Launcher","Settings","Volume Mute","Volume -","Volume +","Brightness -",
           "Brightness +","Wlan","Lock","Touch Pad","Screen Rotate","Browser","Stamp","Canc",
...
"L_Ctrl","Search","Recent task","L_Alt","Space","R_Alt","Menu","R_Ctrl","PgUp","Pad_Up","PgDn",
   ...
   BoardKeyITA[] bkey=new BoardKeyITA[84];
	  {
		  for(int i=0;i<84;i++)
		 {bkey[i]=new BoardKeyITA();
	      }
  	  for(int i=0;i<84;i++){
  ...
  public void onCreate(Bundle savedInstanceState) {
      ...
      setContentView(R.layout.keyboard_ita_test);
    ...
    //  skipButton = (Button)findViewById(R.id.btn_Skip);
      ...
      failButton.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
				...
				KeyboardITATestActivity.this.finish();
			}
		});
		/*
