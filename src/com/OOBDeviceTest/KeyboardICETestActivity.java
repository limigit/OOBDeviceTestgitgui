...
"Tab","Q","W","E","R","T","Y","U","I","O","P","D-","?","*",
"Caps Lock","A","S","D","F","G","H","J","K","L","A=","^","Enter",
"L_Shift",">","Z","X","C","V","B","N","M",",",".","P`","R_Shift",
"L_Ctrl","Search","Recent task","L_Alt","Space","R_Alt","Menu","R_Ctrl","PgUp","Pad_Up","PgDn",
         "Pad_Left","Pad_Down","Pad_Right"};
	 
   BoardKeyICE[] bkey=new BoardKeyICE[84];
	  {
		  for(int i=0;i<84;i++)
		 {bkey[i]=new BoardKeyICE();
	      }
  	  for(int i=0;i<84;i++){
   ...
   private final static String TAG = "KeyboardICETestActivity";  
  ...
  public void onCreate(Bundle savedInstanceState) {
      ...
      setContentView(R.layout.keyboard_ice_test);
    ...
    //  skipButton = (Button)findViewById(R.id.btn_Skip);
      ...
      failButton.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
				...
				KeyboardICETestActivity.this.finish();
			}
		});
		/*
