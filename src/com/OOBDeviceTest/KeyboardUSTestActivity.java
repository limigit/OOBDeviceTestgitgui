...
"L_Ctrl","Search","Recent task","L_Alt","Space","R_Alt","Menu","R_Ctrl","PgUp","Pad_Up","PgDn",
	 ...
	 BoardKeyUS[] bkey=new BoardKeyUS[83];
	  {
		  for(int i=0;i<83;i++)
		 {bkey[i]=new BoardKeyUS();
	      }
  	  for(int i=0;i<83;i++){
   ...
   private final static String TAG = "KeyboardUSTestActivity";  
   private TextView edi22;
  
   private boolean[] test_states=new boolean[83];
  ...
  public void onCreate(Bundle savedInstanceState) {
      ...
      setContentView(R.layout.keyboard_us_test);
      ...
      imageButton[57]=(ImageButton)findViewById(R.id.l5n1);imageButton[58]=(ImageButton)findViewById(R.id.l5n2);imageButton[59]=(ImageButton)findViewById(R.id.l5n3); 
      imageButton[60]=(ImageButton)findViewById(R.id.l5n4);imageButton[61]=(ImageButton)findViewById(R.id.l5n5);imageButton[62]=(ImageButton)findViewById(R.id.l5n6);
      imageButton[63]=(ImageButton)findViewById(R.id.l5n7);imageButton[64]=(ImageButton)findViewById(R.id.l5n8);imageButton[65]=(ImageButton)findViewById(R.id.l5n9);
      imageButton[66]=(ImageButton)findViewById(R.id.l5n10);imageButton[67]=(ImageButton)findViewById(R.id.l5n11);imageButton[68]=(ImageButton)findViewById(R.id.l5n12);
      imageButton[69]=(ImageButton)findViewById(R.id.l6n1);imageButton[70]=(ImageButton)findViewById(R.id.l6n2);imageButton[71]=(ImageButton)findViewById(R.id.l6n3); 
      imageButton[72]=(ImageButton)findViewById(R.id.l6n4);imageButton[73]=(ImageButton)findViewById(R.id.l6n5);imageButton[74]=(ImageButton)findViewById(R.id.l6n6);
      imageButton[75]=(ImageButton)findViewById(R.id.l6n7);imageButton[76]=(ImageButton)findViewById(R.id.l6n8);
      imageButton[77]=(ImageButton)findViewById(R.id.l6n9u);imageButton[78]=(ImageButton)findViewById(R.id.l6n10u);imageButton[79]=(ImageButton)findViewById(R.id.l6n11u);
      imageButton[80]=(ImageButton)findViewById(R.id.l6n9d);imageButton[81]=(ImageButton)findViewById(R.id.l6n10d); imageButton[82]=(ImageButton)findViewById(R.id.l6n11d);
      ...
      failButton = (Button)findViewById(R.id.btn_Fail);
       ...
       try{
    	  ...
    	  int a=ecService.DeviceCtrl(10,1);	
    	  Log.v("limi KB====","a= "+a);
    	  if(a==1){
    		  ecService.DeviceCtrl(1,1);
    		  int b=ecService.DeviceCtrl(10,1);	
    		  Log.v("limi KB====","b= "+b);
    	  }
      }catch (Exception e) {
      }
