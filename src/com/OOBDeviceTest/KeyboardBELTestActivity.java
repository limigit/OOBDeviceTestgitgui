...
public class KeyboardBELTestActivity extends Activity {

	int []key=new int[]{4,3,231,176,91,25,24,223,224,220,226,222,228,64,120,112,
	   		68,8,9,10,11,12,13,14,15,16,7,76,69,67,
	   		61,29,54,33,46,48,53,49,37,43,44,71,72,73,
	   		115,45,47,32,34,35,36,38,39,40,41,75,66,
	   		59,81,51,52,31,50,30,42,55,74,56,70,60,
...
"3 2","1","2","3","4","5","6","7","8","9","0",")","-","Backspace",
"Tab","A","Z","E","R","T","Y","U","I","O","P","[","]","`",
"ShiteLk","Q","S","D","F","G","H","J","K","L","M","%","Enter",
"L_Shift","<","W","X","C","V","B","N",",",";",":","=","R_Shift",
"L_Ctrl","Search","Recent task","L_Alt","Space","R_Alt","Menu","R_Ctrl","PgUp","Pad_Up","PgDn",
         "Pad_Left","Pad_Down","Pad_Right"};
	 
   BoardKeyBEL[] bkey=new BoardKeyBEL[84];
	  {
		  for(int i=0;i<84;i++)
		 {bkey[i]=new BoardKeyBEL();
	      }
  	  for(int i=0;i<84;i++){
  ...
  public void onCreate(Bundle savedInstanceState) {
      ...
      setContentView(R.layout.keyboard_bel_test);
    ...
    //  skipButton = (Button)findViewById(R.id.btn_Skip);
      ...
      failButton.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
				...
				KeyboardBELTestActivity.this.finish();
			}
		});
		/*
