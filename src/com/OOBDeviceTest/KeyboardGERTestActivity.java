...
public class KeyboardGERTestActivity extends Activity  {
   ...
   String[] keyName=new String[]{"Back","Home" ,"Launcher","Settings","Volume Mute","Volume -","Volume +","Brightness -",
           "Brightness +","Wlan","Lock","Touch Pad","Screen Rotate","Browser","Druck","Entf",
"^","1","2","3","4","5","6","7","8","9","0","?","`","Backspace",
"Tab","Q","W","E","R","T","Z","U","I","O","P","U..","*","#",
"Caps Lock","A","S","D","F","G","H","J","K","L","O..","A..","Enter",
"L_Shift",">","Y","X","C","V","B","N","M",",",".","-","R_Shift",
"L_strg","Search","Recent task","L_Alt","Space","R_Alt","Menu","R_strg","PgUp","Pad_Up","PgDn",
         "Pad_Left","Pad_Down","Pad_Right"};
	 
   BoardKeyGER[] bkey=new BoardKeyGER[84];
	  {
		  for(int i=0;i<84;i++)
		 {bkey[i]=new BoardKeyGER();
	      }
  	  for(int i=0;i<84;i++){
  ...
  public void onCreate(Bundle savedInstanceState) {
      ...
      setContentView(R.layout.keyboard_ger_test);
    ...
    //  skipButton = (Button)findViewById(R.id.btn_Skip);
      ...
      failButton.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
				...
				KeyboardGERTestActivity.this.finish();
			}
		});
		/*
