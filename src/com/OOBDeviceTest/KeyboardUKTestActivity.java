...
public class KeyboardUKTestActivity extends Activity  {
...
"L_Ctrl","Search","Recent task","L_Alt","Space","R_Alt","Menu","R_Ctrl","PgUp","Pad_Up","PgDn",
   ...
   BoardKeyUK[] bkey=new BoardKeyUK[84];
	  {
		  for(int i=0;i<84;i++)
		 {bkey[i]=new BoardKeyUK();
	      }
  	  for(int i=0;i<84;i++){
  ...
  public void onCreate(Bundle savedInstanceState) {
      ...
      setContentView(R.layout.keyboard_uk_test);
    ...
    //  skipButton = (Button)findViewById(R.id.btn_Skip);
      ...
      failButton.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
				...
				KeyboardUKTestActivity.this.finish();
			}
		});
		/*
